...
\begin{aside}
One typical use is to implode a \q{cons} list of \q{integer}s (which are interpreted as unicode code points) into a \q{string}.\end{aside}
...
\begin{aside}
One typical use is to explode a \q{string} into a \q{cons} list of \q{integer} code points.\end{aside}
